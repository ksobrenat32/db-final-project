...
GRANT CREATE VIEW, CREATE SEQUENCE, CREATE SYNONYM, CREATE PUBLIC SYNONYM, CREATE TABLE, CREATE PROCEDURE, CREATE TRIGGER, CREATE SESSION, CREATE ANY DIRECTORY TO rol_admin;
